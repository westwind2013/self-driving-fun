...
class TLDetector(object):
    def __init__(self):
        ...
        sub1 = rospy.Subscriber('/current_pose', PoseStamped, self.set_pose)
        sub2 = rospy.Subscriber('/base_waypoints', Lane, self.set_waypoints)
        ...
        '''
        sub3 = rospy.Subscriber('/vehicle/traffic_lights', TrafficLightArray, self.set_traffic_lights)
        sub6 = rospy.Subscriber('/image_color', Image, self.process_images)
    ...
    def set_traffic_lights(self, msg):
